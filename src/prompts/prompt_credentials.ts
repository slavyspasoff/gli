...
const getCredentials = async () => {
  type ReadFromFile = { readFromFile: 'Yes' | 'No' | 'Exit' }
  const question: readonly [DistinctQuestion<ReadFromFile>] = [
    {
      type: 'list',
      name: 'readFromFile',
...
export { getCredentials as default, type Answer as AnswerCredential }
